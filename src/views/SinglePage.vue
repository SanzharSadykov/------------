          ...
          <div class="flex items-center">
            ...
            <div>
              <p class="text-xl text-white">
                {{ this.$route.params.item.user.username }}
              </p>
              <p
                class="text-base text-white"
                v-if="this.$route.params.item.user.twitter_username != null"
              >
                twitter: {{ this.$route.params.item.user.twitter_username }}
              </p>
              <p
                class="text-base text-white"
                v-if="this.$route.params.item.user.instagram_username != null"
              >
                instagram: {{ this.$route.params.item.user.instagram_username }}
              </p>
            </div>
          </div>
          <p @click="addImage(setItem)" class="font-bold text-xl">
            В избранное
          </p>
        </div>
        <img
